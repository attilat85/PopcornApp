...
internal enum Asset {
  ...
  internal enum Images {
    internal static let appLogoLarge = ImageAsset(name: "App logo Large")
    internal static let appLogoMedium = ImageAsset(name: "App logo medium")
    internal static let appLogoSmall = ImageAsset(name: "App logo small")
